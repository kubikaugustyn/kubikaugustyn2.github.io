...
{
    "use strict";
    var n, r = this && this.__assign || function()
    {
    ...
    function a(e, o)
    {
        var t = encodeURIComponent(window.location.protocol + "//" + window.location.host),
        ...
        o = Boolean(o);
        var u = Dropbox.baseUrl + "/chooser?origin=" + t + "&app_key=" + n + "&link_type=" + r + "&trigger=" + a + "&multiselect=" + c + "&extensions=" + l + "&folderselect=" + p + "&iframe=" + o;
        return void 0 !== e.fileselect && (u = i(u, "fileselect", Boolean(e.fileselect))), void 0 !== e.sizeLimit && (u = i(u, "size_limit", e.sizeLimit)), null != e.initialNavigation && (null != e.initialNavigation.mode && (u = i(u, "initial_navigation_mode", encodeURIComponent(e.initialNavigation.mode))), null != e.initialNavigation.role && (u = i(u, "initial_navigation_role", encodeURIComponent(e.initialNavigation.role))), e.initialNavigation.cursor && (u = i(u, "initial_navigation_cursor", encodeURIComponent(e.initialNavigation.cursor)))), null != e.initialViewType && (u = i(u, "initial_view_type", encodeURIComponent(e.initialViewType))), null != e.fields && (u = i(u, "fields", encodeURIComponent("function" == typeof e.fields.join ? e.fields.join(" ") : void 0))), !1 === e.showSignOut && (u = i(u, "show_sign_out", "false")), e.initialNavigationPath && (u = i(u, "initial_navigation_path", encodeURIComponent(e.initialNavigationPath))), e.requiredPermissions && (u = i(u, "required_permissions", encodeURIComponent(d(e.requiredPermissions, "join", function(e)
        {
            return e.join(" ")
        }) || ""))), s(u)
    }
    ...
    function c(e)
    {
        var t = {
            ...
            {}, e),
            {
                ...
                {
                    "function" == typeof e.success && e.success(n, r), o.currentChooserSession === t && (o.currentChooserSession = null)
                },
                cancel: function(n)
                {
                    "function" == typeof e.cancel && e.cancel(n), o.currentChooserSession === t && (o.currentChooserSession = null)
                }
            })
        };
    ...
    function p(e, o)
    {
        var t, r = encodeURIComponent(Dropbox.appKey),
            i = Dropbox.baseUrl + "/dropins/job_status?job=" + o + "&app_key=" + r;
        i = s(i);
        var a = function(o)
        {
            "COMPLETE" === o.status ? ("function" == typeof e.progress && e.progress(1), "function" == typeof e.success && e.success()) : "PENDING" === o.status || "DOWNLOADING" === o.status ? (null != o.progress && "function" == typeof e.progress && e.progress(o.progress / 100), setTimeout(t, 1500)) : "FAILED" === o.status && "function" == typeof e.error && e.error(o.error)
        };
        if ("withCredentials" in new XMLHttpRequest) t = function()
        {
        ...
        else t = function()
        {
            ...
            {
                if ("loaded" === r.readyState) return t || "function" == typeof e.error && e.error(), null != r.parentNode ? r.parentNode.removeChild(r) : void 0
    ...
    function u(e, t, n)
    {
        ...
        switch (r = null != o.ieframe && n._popup ? o.ieframe.contentWindow : e.source, void 0 !== i.sequence_number && r.postMessage(JSON.stringify(
        {
            method: "ack",
        ...
        }), Dropbox.baseUrl), i.method)
        {
            ...
            case "ready":
                if (null != n.files)
                {
                    ...
                    {
                        for (var a = [], c = 0; c < n.files.length; c++)
                        {
                            var l = n.files[c];
                            a.push(
                            {
                    ...
                    if (r.postMessage(s, Dropbox.baseUrl), null != n._ews_auth_token)
                    {
            ...
            case "files_selected":
            case "files_saved":
                "function" == typeof t && t(), "function" == typeof n.success && n.success(i.params, o.last_navigation);
                break;
            case "cursor_changed":
                o.last_navigation = {
                    cursor: i.params
            ...
            case "progress":
                ...
                break;
            case "close_dialog":
                "function" == typeof t && t(), "function" == typeof n.cancel && n.cancel(o.last_navigation);
                break;
            case "resize":
            ...
            case "error_and_close":
                ...
                break;
            case "job_id":
                "function" == typeof t && t(), p(n, i.params);
                break;
            case "save_callback":
                ! function(e, o, t)
                {
                    if (e._fetch_url_on_save)
                    {
                        ...
                        "function" != typeof n && "function" == typeof e.error && e.error("Something went wrong, file url callback not provided."), n(function(e)
                        {
    ...
    function d(e, o, t)
    {
        return void 0 !== e && null !== e && "function" == typeof e[o] ? t(e, o) : void 0
    }
    ...
    }, o.createChooserSession = c, o.createWidgetElement = l, o.handleJobId = p, o.handleMessageEvent = u, o.saverUrl = function(e)
    {
        var o = encodeURIComponent(window.location.protocol + "//" + window.location.host),
            t = encodeURIComponent(Dropbox.appKey);
        return e = Boolean(e), s(Dropbox.baseUrl + "/saver?origin=" + o + "&app_key=" + t + "&iframe=" + e)
    }, o.__guardMethod__ = d, o.initModule = function()
    {
        o.last_navigation = {}, o.ieframe = null, o.currentChooserSession = null, n = 1, null == Dropbox.baseUrl && (Dropbox.baseUrl = "https://www.dropbox.com"), null == Dropbox.blockBaseUrl && (Dropbox.blockBaseUrl = "https://dl-web.dropbox.com"), Dropbox.addListener = function(e, o, t)
        {
            e.addEventListener ? e.addEventListener(o, t, !1) : e.attachEvent("on" + o, function(e)
            {
        ...
        }, Dropbox.createChooserWidget = function(e)
        {
            ...
            {
                e.source === t.contentWindow && e.origin === Dropbox.baseUrl && u(e, null, o.options)
...
}, function(e, o, t)
{
    ...
    var n = this && this.__spreadArrays || function()
    {
        ...
        var n = Array(e),
            r = 0;
        for (o = 0; o < t; o++)
            for (var i = arguments[o], s = 0, a = i.length; s < a; s++, r++) n[r] = i[s];
        return n
    };
    Object.defineProperty(o, "__esModule",
    {
    ...
    var r = window.location.protocol + "//" + window.location.host,
        i = function()
        {
            function e(o)
            {
                if (this.origin = r, this.sendMessage = function(e) {}, this.state = {}, this.options = o, !this.options) throw new Error("options must be provided");
...
}, function(e, o, t)
{
    ...
    o.genericDropins = {
        init: function() {}
    }, o.createDropinButton = i, o.filenameFromPath = s, o.initModule = function()
    {
        var e;
        n.initModule(), null == Dropbox.appKey && (Dropbox.appKey = null === (e = document.getElementById("dropboxjs")) || void 0 === e ? void 0 : e.getAttribute("data-app-key")), Dropbox.init = function(e)
        {
        ...
        {
            var o, t, n;
            if ("string" == typeof e[0]) n = e.shift(), o = "string" == typeof e[0] ? e.shift() : a(n), (t = e.shift() ||
            {}).files = [
            {
                url: n,
                filename: o
            ...
            else
            {
                ...
                for (var r = 0; r < t.files.length; r++)
                {
                    var i = t.files[r];
                    if ("function" == typeof i.url && (t._fetch_url_on_save = !0, t.fetch_urls_fn = i.url, i.url = null, r > 0)) throw new Error("Old style url as callback is only supported for single files.");
        ...
        Dropbox.save = function()
        {
            ...
            if (Dropbox.isBrowserSupported())
            {
                ...
                var l = n.popupDimensionsString(735, 670);
                return s(n.saverUrl(r.iframe), l, r).window
            }
        ...
        var s = function(e, o, t)
            {
                var r = function()
                    ...
                    i = function(e)
                    {
                        e.source !== a && e.source !== (void 0 !== n.ieframe && null !== n.ieframe ? n.ieframe.contentWindow : void 0) || n.handleMessageEvent(e, r, t)
                    },
                ...
                var c = setInterval(function()
                {
                    (function()
                    {
                        ...
                        {}
                    })() && (r(), "function" == typeof t.cancel && t.cancel(n.last_navigation))
                }, 100);
            ...
            c = function(e)
            {
                ...
                if (null != e.extensions && null != Array.isArray)
                    if (Array.isArray(e.extensions))
                        for (var t = 0, i = e.extensions; t < i.length; t++)
                        {
                            var s = i[t];
                            s.match(/^\.[\.\w$#&+@!()\-'`_~]+$/) || -1 !== r.indexOf(s) || o()
                        }
                else o();
                return void 0 !== e.sizeLimit && "number" != typeof e.sizeLimit && e.sizeLimit <= 0 && n.__guardMethod__(console, "error", function(e)
                {
            ...
            l = function(e)
            {
                if (Dropbox.isBrowserSupported())
                {
                    var o, t, r = n.createChooserSession(e);
                    if (e.iframe && !e.windowName)
                    {
                        var i = (o = n.chooserUrl(e, !0), (t = document.createElement("iframe")).src = o, t.style.display = "block", t.style.backgroundColor = "white", t.style.border = "none", t);
                    ...
                    {
                        var l = n.popupDimensionsString(735, 552);
                        r.onClose = s(n.chooserUrl(r.options, r.options.iframe), l, r.options).onClose
                    }
                }
        ...
        {
            n.currentChooserSession && (n.currentChooserSession.onClose && n.currentChooserSession.onClose(), n.currentChooserSession.options.cancel && n.currentChooserSession.options.cancel(n.last_navigation))
        ...
        }, Dropbox.createSaveButton = function()
        {
            ...
            var n = t(e),
                r = e.shift();
            return r = i("Save to Dropbox", r), Dropbox.addListener(r, "click", function(e)
            {
                if (e.preventDefault(), r.className.indexOf("dropbox-dropin-error") >= 0 || r.className.indexOf("dropbox-dropin-default") >= 0 || r.className.indexOf("dropbox-dropin-disabled") >= 0)
                {
                    ...
                    if (!(null != o ? o.length : void 0)) return r.className = "dropbox-dropin-btn dropbox-dropin-error", void("function" == typeof n.error && n.error("Missing files"));
                    Dropbox.save(
                    {
                        files: o,
                        success: function()
                        {
                            r.className = "dropbox-dropin-btn dropbox-dropin-success", "function" == typeof n.success && n.success()
                        },
                        progress: function(e)
                        {
                            r.className = "dropbox-dropin-btn dropbox-dropin-progress", "function" == typeof n.progress && n.progress(e)
                        },
                        cancel: function()
                        {
                        ...
                        error: function(e)
                        {
                            r.className = "dropbox-dropin-btn dropbox-dropin-error", "function" == typeof n.error && n.error(e)
                        }
                    })
                }
            }), r
        ...
        u.styleSheet ? u.styleSheet.cssText = d : u.textContent = d, document.getElementsByTagName("head")[0].appendChild(u), setTimeout(n.createIEFrame, 0);
        var f = function()
        {
            document.removeEventListener ? document.removeEventListener("DOMContentLoaded", f, !1) : document.detachEvent && document.detachEvent("onreadystatechange", f), n.createIEFrame(), o.genericDropins.init()
        };
...
{
    "use strict";
    var n, r = this && this.__extends || (n = function(e, o)
    {
    ...
    var i = "https://www.dropbox.com/developers/dropins/chooser/js",
        ...
        a = function(e)
        {
            function o(o)
            {
                ...
                return t.validateOptions = function()
                {
                    var e = function(e, o)
                    {
                        if (void 0 !== t.options[e] && typeof t.options[e] !== o) throw new Error("The " + e + " option, if provided, must have type " + o)
                    };
                    ...
                    var a = t.options.initialNavigation;
                    if (void 0 !== a)
                    {
                    ...
                    if (e("initialViewType", "string"), void 0 !== t.options.fields)
                    {
                        ...
                        for (var c = 0, l = t.options.fields; c < l.length; c++)
                            if ("string" != typeof l[c]) throw new Error("The fields option, if provided, must be an array of strings")
                    }
                    if (e("showSignOut", "boolean"), e("version", "string"), e("cl", "string"), "function" != typeof t.options.onSuccess) throw new Error("You must provide a success callback to the Chooser to see the files that the user selects");
...
}, , , function(e, o, t)
{
    ...
    {
        value: !0
    }), t(7).initModule(), o.Dropbox = window.Dropbox
}, function(e, o, t)
{
    "use strict";
    ...
    o.initModule = function()
    {
        ...
        Dropbox.unmount = o, Dropbox.closeWindow = o, Dropbox.Mover = l.Mover, Dropbox.Previewer = p.Previewer, Dropbox.Chooser = s.Chooser, Dropbox.ZoomChooser = a.ZoomChooser, Dropbox.embed = function(e, o)
        {
            Dropbox.appKey && (e = n(n(
            {}, e),
            {
                appKey: Dropbox.appKey
            })), Dropbox.mount(new c.Embed(e), o)
            ...
            for (var e = document.getElementsByTagName("a"), o = e.length - 1; o >= 0; o--)
            {
                ...
                }(t) : n.indexOf("dropbox-embed") >= 0 && function(e)
                {
                    ...
                    if (o && e.parentElement)
                    {
                        ...
                        t.classList.add("dropbox-embed-container"), t.style.height = e.getAttribute("data-height") || "100%", t.style.width = e.getAttribute("data-width") || "100%", e.parentElement.replaceChild(t, e), Dropbox.embed(
                        {
                            link: o
                        }, t)
                    }
...
}, function(e, o, t)
{
    ...
    function r(e)
    {
        return function()
        {
            for (var o = 0, t = e; o < t.length; o++)(0, t[o])()
        }
    }
        ...
        s = function()
        {
                ...
                }, this.openWindow = function(t)
                {
                    ...
                    try
                    {
                        var a = t.url(),
                            ...
                            l = n.PopupEnvironment.open(c, t.windowDimensions(), function()
                            {
                                s()
                            });
                        s = r([l.stopInterval, s]);
                        var p = e.attach(t, l.messagingWindow);
                        s = r([function()
                        {
                            t.sendMessage(
                            {
                        ...
                        e.activeDropins.push(u), s = r([e.deleteActiveDropin(u), s]), t.hasOnCloseDialogMessage() || t.setOnCloseDialogMessage(s), u.cleanup = s
                    }
                    catch (e)
                    {
                        throw s(), e
            ...
            return e.prototype.mount = function(e, t)
            {
                ...
                try
                {
                    ...
                    n = r([this.attach(e, function()
                    {
                        if (!s.contentWindow) throw new Error("iframe does not contain a contentWindow");
                        return s.contentWindow
                    }), n]);
                    var a = e.url();
                    s.src = "" + o.TARGET_ORIGIN + a.pathname + a.search + "&iframe=true", t.appendChild(s), n = r([function()
                    {
                        t.removeChild(s)
                    }, n]);
                    var c = {
                    ...
                    this.activeDropins.push(c), n = r([this.deleteActiveDropin(c), n]), e.hasOnCloseDialogMessage() || e.setOnCloseDialogMessage(n), c.cleanup = n
                }
                catch (e)
                {
                    throw n(), e
            ...
            }, e.prototype.attach = function(e, t)
            {
                ...
                return window.addEventListener("message", n),
                    function()
                    {
                        e.sendMessage = i, window.removeEventListener("message", n)
                    }
    ...
    var n = t(0),
        r = function()
        {
            function e(e, o)
            {
                ...
                {
                    return void 0 !== n.ieframe && null !== n.ieframe ? n.ieframe.contentWindow : t.popupWindow
...
}, function(e, o, t)
{
    ...
    var s = function(e)
    {
        function o(t)
        {
            ...
            }, n.onSuccess = n.options.onSuccess, n.onCancel = n.options.onCancel, n
        }
