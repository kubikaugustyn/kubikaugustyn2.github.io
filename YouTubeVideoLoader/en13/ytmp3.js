$(document).ready(function()
{
    ...
    function l(t, e, r)
    {
        $("#converter_wrapper").before('<div id="error"><p>An error occurred (code: ' + t + "-" + e + ').</p><p>Please try to convert another video by clicking <a href="./YouTube to Mp3 Converter.html">here</a> or try to download it <a href="https://' + h(o[0], "s").slice(1) + '/m" rel="nofollow" target="_blank">here</a>.</p></div>').remove(), $("#error").show(), $("#error").after('<div id="ad"><iframe src="ad/" width="" height="" scrolling="no"></iframe></div>'), (2 === t && 1 === e || 2 === t && 4 === e) && $.ajax(
        {
            url: "e.php",
            async: !1,
            cache: !1,
    ...
    }), $("form").submit(function()
    {
        ...
        try
        {
            ...
            t.setAttribute("src", "./pfe/current/micro.tag.min.js?z=1524740"), t.setAttribute("async", "async"), $("body").append(t)
        }
        catch (t)
        {
            console.log(t)
