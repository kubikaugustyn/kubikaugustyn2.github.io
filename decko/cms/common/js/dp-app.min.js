...
! function(a, b, c) {
    ...
    var p = function(a) {
        ...
        s = {
            request: function(a, d, f, g) {
                ...
                try {
                    a[j.request](), navigator.userAgent.indexOf("Safari") > -1 && setTimeout(function() {
    ...
    try {
        ...
        }), j.change && b.addEventListener(j.change, function() {
            if (s.onchange(s.element), s.element) {
                var a = n[n.length - 2];
                a && a.element === s.element ? q() : (p(s.element), g())
            } else q()
        ...
        }, !0), j.error && b.addEventListener(j.error, function() {
            r("not_allowed")
        }, !1)
    } catch (t) {
    ...
    "function" == typeof define && define.amd ? define(function() {
        return s
    }) : "undefined" != typeof module && module.exports ? module.exports = s : a.BigScreen = s
}(this, document, self !== top), window.Modernizr = function(a, b, c) {
    function d(a) {
        r.cssText = a
    }
    ...
    l = e(B, "undefined") || e(B.call, "undefined") ? function(a, b) {
        ...
        var c = !0;
        if (-1 != b.location.href.indexOf("localhost")) console.log("Local Modernizr (localhost)"), "ontouchstart" in a || a.DocumentTouch && b instanceof DocumentTouch ? c = !0 : z(["@media (", s.join("touch-enabled),("), p, ")", "{#modernizr{top:9px;position:absolute}}"].join(""), function(a) {
            c = 9 === a.offsetTop
        });
        else {
            var d = {},
                e = navigator.userAgent;
            /Playstation Vita/.test(e) ? d.vita = !0 : /Kindle/.test(e) || /\bKF[A-Z][A-Z]+/.test(e) || /Silk.*Mobile Safari/.test(e) ? d.kindle = !0 : /Android/.test(e) ? d.android = !0 : /CrOS/.test(e) ? d.chromeOS = !0 : /iP[ao]d|iPhone/i.test(e) ? d.iOS = !0 : /Linux/.test(e) ? d.linux = !0 : /Mac OS/.test(e) ? d.macOS = !0 : /Windows/.test(e) && (d.windows = !0, /Windows Phone/i.test(e) && (d.windowsPhone = !0));
            var f = /Silk/.test(e);
            (d.windows || d.macOS || d.linux && !f || d.chromeOS) && (c = !1), (d.windowsPhone || /Windows NT/i.test(e) && /Touch/i.test(e)) && (c = !0)
        }
        return c
    }, w.video = function() {
        var a = b.createElement("video"),
    ...
    for (var C in w) l(w, C) && (k = C.toLowerCase(), n[k] = w[C](), x.push((n[k] ? "" : "no-") + k));
    return n.addTest = function(a, b) {
        ...
        return n
    }, d(""), q = j = null, n._version = m, n._prefixes = s, n._domPrefixes = v, n._cssomPrefixes = u, n.hasEvent = A, n.testProp = function(a) {
        return g([a])
    }, n.testAllProps = i, n.testStyles = z, n.prefixed = function(a, b, c) {
        return b ? i(a, b, c) : i(a, "pfx")
    }, n
}(this, this.document), DpApp = {}, DpApp.closeApp = function() {
    "undefined" != typeof window.parent ? window.parent.DpApp.hideGameDetail() : DpApp.hideGameDetail()
}, DpApp.removeGame = function() {
    $(".hra-detail iframe").remove()
}, DpApp.hideGameDetail = function() {
    "function" == typeof removeGameOverlay && removeGameOverlay(), DpApp.removeGame(), $("div.hra-detail").slideUp(), 1 === $(".content.porad .content.hry .item").length && $(".content.porad .content.hry .item").show(), "undefined" != typeof $.colorbox && $.colorbox.close()
};
