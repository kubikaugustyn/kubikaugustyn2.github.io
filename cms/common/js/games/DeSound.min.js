...
DeSnd.SoundManager = function () {
    ...
    var b = this._sounds.indexOf(a);
    -1 !== b && this._sounds.splice(b, 1)
...
}, DeSnd.Loader.prototype._init = function () {
}, DeSnd.Loader.prototype.load = function (a) {
...
}, DeSnd.SndGroup.prototype._init = function () {
}, DeSnd.SndGroup.prototype.fade = function (a, b, c) {
    ...
    if (this._groupRef) {
        var a = this._groupRef.sndArr.indexOf(this);
        -1 !== a && this._groupRef.sndArr.splice(a, 1)
    }
